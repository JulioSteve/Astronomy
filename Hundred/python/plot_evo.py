...
def make_images(in_i, figsize):
    ...
    ax.scatter(data[in_i, :, 0], data[in_i, :, 1], data[in_i, :, 2], s=30, color='w', linewidths=0, edgecolors="none")
...
def make_gif(in_nb):
    ...
    im[0].save('../output/pos.gif', save_all=True, append_images=im[1:], fps=240, loop=0)
